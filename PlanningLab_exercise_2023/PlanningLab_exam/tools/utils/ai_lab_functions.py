...
def update_reward_array(rewards):
    return [rewards["S"], rewards["F"], rewards["F"], rewards["F"],
            rewards["F"], rewards["H"], rewards["F"], rewards["H"],
            rewards["F"], rewards["F"], rewards["F"], rewards["H"],
            rewards["H"], rewards["F"], rewards["F"], rewards["G"]]
...
def real_cost_to_goal(node):
        costs = [14, 13, 12, 11, 10, 9, 8, 7,
                13, 12, 11, 10, 9, 8, 7, 6,
                12, 11, 10, 9, 8, 7, 6, 5,
                11, 10, 9, 8, 7, 6, 5, 4,
                12, 11, 10, 7, 6, 5, 4, 3,
